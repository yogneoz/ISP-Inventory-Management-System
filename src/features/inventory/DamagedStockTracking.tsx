      ...
      <div className="flex-none flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="shrink-0 flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 rounded-xl px-3 py-2 text-xs font-semibold border transition-all cursor-pointer bg-white text-slate-700 border-slate-200 hover:bg-slate-100 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700 dark:hover:bg-slate-700`}
          >
